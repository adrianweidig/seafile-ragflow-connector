...
<p align="center">
  ...
  <a href="pyproject.toml"><img alt="Version 0.1.6" src="https://img.shields.io/badge/version-0.1.6-informational.svg"></a>
...
wie `0.1.6` gepinnt werden; `latest` ist eine Komfortoption für Smoke-Tests und
frische Testumgebungen.

```bash
docker pull ghcr.io/adrianweidig/seafile-ragflow-connector:0.1.6
```
...
```bash
docker save \
  ghcr.io/adrianweidig/seafile-ragflow-connector:0.1.6 \
  postgres:16 \
  redis:7 \
...
```env
CONNECTOR_IMAGE=seafile-ragflow-connector:0.1.6
