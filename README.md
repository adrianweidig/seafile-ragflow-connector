...
<p align="center">
  ...
  <a href="pyproject.toml"><img alt="Version 2.4.9" src="https://img.shields.io/badge/version-2.4.9-informational.svg"></a>
...
wie `2.4.9` gepinnt werden; `latest` ist eine Komfortoption für Smoke-Tests und
frische Testumgebungen.

```bash
docker pull ghcr.io/adrianweidig/seafile-ragflow-connector:2.4.9
```
...
```bash
docker save \
  ghcr.io/adrianweidig/seafile-ragflow-connector:2.4.9 \
  postgres:16 \
  redis:7 \
...
```env
CONNECTOR_IMAGE=seafile-ragflow-connector:2.4.9
