...
<p align="center">
  ...
  <a href="pyproject.toml"><img alt="Version 2.4.7" src="https://img.shields.io/badge/version-2.4.7-informational.svg"></a>
...
wie `2.4.7` gepinnt werden; `latest` ist eine Komfortoption für Smoke-Tests und
frische Testumgebungen.

```bash
docker pull ghcr.io/adrianweidig/seafile-ragflow-connector:2.4.7
```
...
```bash
docker save \
  ghcr.io/adrianweidig/seafile-ragflow-connector:2.4.7 \
  postgres:16 \
  redis:7 \
...
```env
CONNECTOR_IMAGE=seafile-ragflow-connector:2.4.7
